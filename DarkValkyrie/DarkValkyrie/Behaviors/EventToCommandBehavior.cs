...
namespace DarkValkyrie.Behaviors
{
    public class EventToCommandBehavior : BehaviorBase<ImageButton>
    {
        ...
        public static readonly BindableProperty EventNameProperty = BindableProperty.Create("EventName",
                                                                                            typeof(string),
        ...
        public static readonly BindableProperty InputConverterProperty = BindableProperty.Create("Converter",
